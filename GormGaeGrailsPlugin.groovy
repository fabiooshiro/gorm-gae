...
class GormGaeGrailsPlugin {
	...
	def author = "Graeme Rocher, Fabio Oshiro"
	def authorEmail = "graeme.rocher@springsource.com"
	def title = "Grails GormGae plugin"
	def description = '''A plugin that integrates the AppEngine development runtime and deployment tools with Grails.'''
